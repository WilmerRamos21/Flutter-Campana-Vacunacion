...
class EditSectorVaccinationScreen extends StatefulWidget {
  const EditSectorVaccinationScreen({
    super.key,
  ...
  @override
  State<EditSectorVaccinationScreen> createState() =>
      _EditSectorVaccinationScreenState();
}

class _EditSectorVaccinationScreenState
    extends State<EditSectorVaccinationScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      final coordinatorSectorId = userData['sector_id'] as int;
      ...
      if (vaccination.sectorId != coordinatorSectorId) {
        throw Exception(
          'No tienes permiso para editar registros de otro sector.',
        );
      }

      _coordinatorSectorId = coordinatorSectorId;
  ...
  Future<void> _saveChanges() async {
    ...
    if (_vaccination == null || _coordinatorSectorId == null) {
      return;
    }
    ...
    try {
      final updatedVaccination = VaccinationModel(
        ...
        vacunadorId: _vaccination!.vacunadorId,
        sectorId: _coordinatorSectorId,
      );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Editar registros de vacunación'),
      ),
      body: SafeArea(
